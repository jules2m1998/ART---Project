...
class Carousel {
  ...
  createNavigation () {
    ...
    this.onMove((index) => {
      ...
      if ((this.items.length - index <= this.options.slidesToScroll && index + this.options.slidesToScroll >= this.items.length) || this.options.slidesVisible === this.items.length) {
